# app.py — Single-page Streamlit UI (Year Structure + Single-Archetype builder hook)
import io
...
from core.ramp_core import build_multi_archetypes_from_uploads, run_single_archetype, run_multi_archetype


# -----------------------------------------------------------------------------
# Page setup
# -----------------------------------------------------------------------------
st.set_page_config(page_title="RAMP Demand")
st.title("Simulating a load demand profile with RAMP")
...
if not st.session_state.simulation_done:
    ...
    if not names:
        ...
        st.markdown("**Inspect a specific day (Aggregated)**")
